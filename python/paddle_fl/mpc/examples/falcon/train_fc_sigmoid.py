...
# role is 1, 2. Server, IpAddress, Port: localPort
...
# network
x = pfl_mpc.data(name='x', shape=[BATCH_SIZE, 16], dtype='int64')
...
print(f"reading data from {mpc_data_dir}/bank_market2_feature")

# train_reader
feature_reader = mpc_du.load_shares(mpc_data_dir + "bank_market2_feature", id=role, shape=(16,))
label_reader = mpc_du.load_shares(mpc_data_dir + "bank_market2_label", id=role, shape=(1,))
...
# test_reader
test_feature_reader = mpc_du.load_shares(mpc_data_dir + "bank_market2_test_feature", id=role, shape=(16,))
test_label_reader = mpc_du.load_shares(mpc_data_dir + "bank_market2_test_label", id=role, shape=(1,))
...
# loss file
# loss_file = "/tmp/bank_market_output_loss.part{}".format(role)
...
prediction_file = mpc_infer_data_dir + "bank_market_debug_prediction.part{}".format(role)
print("Training done, begin to do the prediction ")
...
print("Prediction done, begin to decrypt \n")


process_data.decrypt_data_to_file( mpc_infer_data_dir + "bank_market_debug_prediction", (BATCH_SIZE,), "./mpc_infer_data/bank_market_output_prediction")
